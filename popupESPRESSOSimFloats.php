<?php
  ...
  if (isset($_REQUEST['u'])) {
    array_push($o,"<tr><td>&nbsp;</td></tr>");
    array_push($o,"<tr><td colspan=2 style='text-align:center'><a target=_blank href='".$_REQUEST['u']."'>More observations and information</a></td></tr>");
  }
